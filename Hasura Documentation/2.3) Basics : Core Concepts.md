...
>>  >> <br/>
>>  >> -> Endpoint merupakan sebuah Spesifik URL (Uniform Resource Locator) di Server yang mewakili Spesifik Resource atau Action (yang mewakili Resource atau Action tertentu). <br/>
>>  >> masing-masing Endpoint sesuai dengan Function atau Bagian Data tertentu pada API. <br/>
>>  >> 
