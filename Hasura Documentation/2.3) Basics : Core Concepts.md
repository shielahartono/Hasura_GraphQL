...
>>```
>><br/>
>> (2) Contoh Query untuk Subscribes ke Tabel Messages : 
...
>> yang mana hal ini dilakukan untuk mengirimkan "Subscription Query" (Query untuk minta Subscription) ke Server Hasura.
