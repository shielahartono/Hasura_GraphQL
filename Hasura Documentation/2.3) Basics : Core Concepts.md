...
>> .  <br/>
[3] **Supergraph** : <br/>
Supergraph adalah Schema Unified GraphQL, yang mana Client berinteraksi dengan Supergraph.
Supergraph merupakan hasil dari penggabungan Semua Subgraph melalui Gateway.

Bagi Client, Supergraph tampak seperti GraphQL API tunggal yang lengkap,
walaupun GraphQL API tersebut dibangun dari beberapa bagian. 
