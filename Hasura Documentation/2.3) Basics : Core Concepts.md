...
>> ^For your information^ <br/>
>> ### {1} **Remote Schemas** <br/>
>>  - Pada GraphQL, "Remote Schemas" memungkinkan kita untuk menggabungkan beberapa "Beberapa GraphQL API" menjadi "Satu Unified API". <br/>
...
>>  - Remote Schema adalah 'External GraphQL API' yang berada di luar 'GraphQL API utama' kita. <br/>
>> ('External GraphQL API' merupakan GraphQL API yang berbeda dari 'GraphQL API utama kita' (Main GraphQL API)).  <br/>
>> 
...
>> maka jika kita ingin meng-akses Data untuk User, Product, Order dari 'Satu GraphQL Endpoint', kita bisa menggunakan "Remote Schemas" untuk menggabungkan banyak API ini. <br/> <br/>
>> ---- 
>> ### {2} **External GraphQL Services** <br/>
>>
>> ----
>> {3} **REST API** : <br/>
