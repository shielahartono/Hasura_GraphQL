...
>> >>   ```
>> >> Pada contoh diatas, "Bearer abcdef12345" merupakan Token yang membantu Server meng-identifikasi apakah kita adalah Authorized User (User yang berwenang). <br/>
>> >> 
>> >> 
>> >> 
>> >> 
