...
-> "GraphQL Federation" mengatasi masalah ini dengan mengizinkan setiap tim untuk bekerja secara independen pada **subgraph** tertentu sementara sistem menggabungkan semua subgraph menjadi satu Unified API. <br/>

>> ^For your information^ <br/>
>> Secara umum, "Federation Architecture" merupakan Design Approach yang memungkinkan beberapa System atau beberapa Service yang independen untuk bekerja bersama sebagai satu kesatuan yang utuh. <br/>
