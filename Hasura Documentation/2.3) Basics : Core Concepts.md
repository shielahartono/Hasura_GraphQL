...
yang mana ini dapat meningkatkan Performance (kinerja) karena dengan Modularity, kita hanya meng-query Data yang kita butuhkan, tanpa harus membebani 'a single Large Schema' (tanpa harus membebani keseluruhan Skema)
