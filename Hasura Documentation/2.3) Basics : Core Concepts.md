...
- Pada GraphQL, Supergraph merupakan "Single & Unified Schema" yang menggabungkan beberapa Subgraph menjadi Satu API. <br/> <br/>
...
Setiap Subgraph itu seperti 'mini API' (API kecil) yang fokus pada bagian spesifik dari Aplikasi. <br/>
...
## 2. Understanding Supergraph for GraphQL in Hasura
