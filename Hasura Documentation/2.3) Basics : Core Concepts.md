...
-> Misalnya Client ingin mengambil Data (Fetch Data) mengenai informasi User dan informasi Order yang telah mereka buat, dengan detail tentang setiap produk dalam pesanan. Query yang Client buat untuk Request Data mungkin terlihat seperti ini:
