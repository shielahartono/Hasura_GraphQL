...
>> (jika kita ingin meminta Tiga jenis data berbeda, misalnya Data User, Product, dan Order, maka kita perlu membuat Tiga Request yang terpisah ke Tiga Endpoint yang berbeda). <br/>  
>>  <br/>
