...
- "Unified API" menggabungkan API untuk semua layanan menjadi satu, yang mana berarti kita hanya perlu menggunakan Satu API untuk banyak layanan.
...
"Unified API" menyatukan semua API tersebut, yang mana hal ini memungkinkan Client (seperti User atau Front-End Application) untuk mengakses semua Data & Services (Layanan) yang dibutuhkan melalui 'Satu API yang terpadu'. <br/>

  


### 2.6) Gateway in GraphQL
