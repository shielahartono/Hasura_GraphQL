...
(4) Unified Response :
Gateway menggabungkan Data dari Semua Subraph, dan mengembalikkannya sebagai "Single Response" (Satu Reponse atau bisa kita sebut "Unified Response").

Contoh "Unified Response" adalah seperti dibawah ini.
Dapat kita lihat bahwa pada Unified Response, semua data dari semua Subgraph digabungkan menjadi satu Response.
