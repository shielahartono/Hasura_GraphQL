...
(1) User Subgraph :  <br/>
Berikut ini adalah bagian Query yang berisikan "User Subgraph"  <br/>
```
user(id: 123) {
    id
    name
...
Berikut ini adalah bagian Query yang berisikan "Orders Subgraph"   <br/>
```
orders {
      id
      total
...
Berikut ini adalah bagian Query yang berisikan "Products Subgraph"  <br/>
```
products {
        id
        name
