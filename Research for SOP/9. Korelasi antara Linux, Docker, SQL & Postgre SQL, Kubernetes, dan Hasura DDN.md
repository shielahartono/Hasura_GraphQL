...
-> Docker digunakan untuk menjalankan PostgreSQL dan Hasura, mengisolasi keduanya dari sistem utama. <br/>
 yang mana, ini artinya, Docker digunakan untuk menjalankan PostgreSQL dan Hasura di dalam container terpisah, yang terisolasi dari sistem operasi utama (host system) <br/><br/><br/>
