...
Contoh: <br/>
Jika Kita mencoba menginstal atau menghapus perangkat lunak tanpa menggunakan `sudo` , Kita akan mendapatkan pesan kesalahan karena Kita tidak memiliki izin yang diperlukan.
